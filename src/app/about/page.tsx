  ...
  return (
    <Layout>
      <div>
        ...
        <Text>
          Right now, I&apos;m at <Link href="https://www.owner.com">Owner</Link>{" "}
          building software for restaurants. Before, I was at{" "}
          <Link href="https://www.nexhealth.com">NexHealth</Link>,{" "}
        ...
        <Text>
          ...
          other engineers, teachers, mentors, and the programming community, so
          my personal website is dedicated to sharing what I&apos;ve learned so{" "}
          {/* These non-breaking spaces prevent this from looking like an unordered list on mobile. */}
          far&nbsp;— my knowledge, mistakes, and experiences&nbsp;— to help
          other people build something they&apos;re proud of.
        </Text>
        <Text>
          This website is{" "}
          ...
          and so are many of my <Link href="/projects">projects</Link>. Feel
          free to email me with any questions or reach out elsewhere on the web.
        </Text>
        <script
